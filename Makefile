...
# translation
SOURCES = isoline.py ui_isoline.py __init__.py isolinedialog.py
#TRANSLATIONS = i18n/isoline_en.ts
TRANSLATIONS =
...
PY_FILES = isoline.py isolinedialog.py __init__.py

EXTRAS = icon.png metadata.txt

UI_FILES = ui_isoline.py
